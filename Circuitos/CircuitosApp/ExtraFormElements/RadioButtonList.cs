...
namespace CircuitosApp.ExtraFormElements
{
    /// <summary>
    /// Esta clase fue obtenida de la web para lograr una implementación mas amigable para el usuario.
    /// Fuente de la clase: https://stackoverflow.com/questions/1015411/winforms-radiobuttonlist-doesnt-exist/41355419#41355419
    /// </summary>
    public class RadioButtonList : ListBox
    {
        ...
        public RadioButtonList()
        {
            ...
            s = RadioButtonRenderer.GetGlyphSize(Graphics.FromHwnd(IntPtr.Zero),
